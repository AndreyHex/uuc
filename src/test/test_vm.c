...
TestResults run_vm_test(int argc, const char *argv[]) {
    ...
    add_result(&r, run_vm_test_case(INT_VAL(10), "var a = 0; while(a<100){if(a==10)break;a=a+1;}"));
    add_result(&r, run_vm_test_case(INT_VAL(100), "var a = 0; while(a<1000){if(a==100)break; { var i=0; while(true){i=i+1;if(i==5)break;} a=a+i; }}"));

    // breaks from different scopes
    add_result(&r, run_vm_test_case(INT_VAL(3), "var a = 0;"
                                                 "while(true){"
                                                 "  var i = 1;"
                                                 "  while(true){"
                                                 "    var i = 2;"
    ...
    add_result(&r, run_vm_test_case(INT_VAL(100), "var a = 0;"
                                                 "while(true){"
                                                 " a=a+1;"
                                                 " {var i = a;if(i<100)continue;}"
                                                 " break;"
                                                 "}"));

    // for
    add_result(&r, run_vm_test_case(INT_VAL(10), "var a = 0; for(var i = 0; i < 5; i = i + 1) a = a + 2;"));
    add_result(&r, run_vm_test_case(INT_VAL(10), "var a = 0; for(var i = 0; i < 5; i = i + 1) a = a + i;"));
    add_result(&r, run_vm_test_case(INT_VAL(1), "var a = 0; for(var i = 1; i < 5; i = i + 1){ a = a + i;i = 10;}"));
    ...
    add_result(&r, run_vm_test_case(INT_VAL(2584), "var a=0;var b=1; for(var i=0;i<18;i=i+1){var tmp=a+b;a=b;b=tmp;}"));
    add_result(&r, run_vm_test_case(INT_VAL(10), "var a = 0; for(;;) {a=a+1;if(a<10)continue;else break;}"));
